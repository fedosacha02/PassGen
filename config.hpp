...
#define ORGANISATION_SHARED_PASSWORDS_LIMIT \
(ORGANISATION_MEMBERS_LIMIT*GROUP_SHARED_PASSWORDS_LIMIT)
// Length limits
...
#define PASSWORDS_LIMIT \
(USERS_LIMIT*USER_PASSWORDS_LIMIT)

#define PASSWORD_SHARINGS_TO_GROUP_LIMIT \
(GROUPS_LIMIT*GROUP_SHARED_PASSWORDS_LIMIT)

#define PASSWORD_SHARINGS_TO_ORGANISATION_LIMIT \
